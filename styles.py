...
/* Main Canvas Radial Gradient Background */
.gradio-container {
...
/* Keyframe Pulsing Neon Button Animation */
...
<div style="text-align: center; padding: 20px 0 10px 0; margin-bottom: 15px;">
 ...
 🔥 SHADOW FLAMEZ AI STUDIO PRO <span style="color:#ff007f; font-size: 0.45em; padding: 3px 8px; border: 1px solid #ff007f; border-radius: 6px; background: rgba(255,0,127,0.15);">v6.0 MASTER</span>
 </h1>
...
<div style="text-align: center; padding: 15px 0; margin-top: 25px; color: #64748b; font-family: 'Orbitron', monospace; font-size: 0.8em; border-top: 1px solid rgba(0, 243, 255, 0.15);">
 ⚡ SHADOW FLAMEZ AI ENGINE v6.0 • MULTI-THREADED CONTAINER ACTIVE
</div>
"""
